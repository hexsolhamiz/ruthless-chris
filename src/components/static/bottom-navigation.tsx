...
import { Wifi, Monitor, Info, Phone, Mail, Share2, Play, Pause, Volume2, VolumeX } from "lucide-react"
...
export function BottomNavigation() {
  ...
  return (
    <nav className="sticky bottom-0 w-full overflow-hidden right-0 bg-blue-950/80 backdrop-blur-3xl z-50">
